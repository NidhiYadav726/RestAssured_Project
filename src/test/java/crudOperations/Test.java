...
public class Test {
    ...
    @org.testng.annotations.Test(priority = 1, description = "Verify successful user creation with valid details")
    ...
    @org.testng.annotations.Test(priority = 2, description = "Verify create user with invalid data inputs")
    ...
    @org.testng.annotations.Test(priority = 4, description = "Verify update user details with invalid data for valid user")
    ...
    @org.testng.annotations.Test(priority = 5, description = "Verify fetch user details of a valid user")
    ...
    @org.testng.annotations.Test(priority = 6, description = "Verify fetch user details of an invalid user")
    ...
    @org.testng.annotations.Test(priority = 7, description = "Verify delete user operation for a valid user")
    ...
    @org.testng.annotations.Test(priority = 8, description = "Verify delete user with invalid authorization token")
